...
**Documentation**: [CRD Schema Reference](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/crds/projectcontext.yaml)
...
**Documentation**: [Agent Communication Protocol](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/docs/agent-communication-protocol.md)
...
See [Semantic Conventions](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/docs/semantic-conventions.md) for complete attribute definitions.
