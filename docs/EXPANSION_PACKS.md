...
Wayfinder expansion packs extend the core framework with specialized capabilities. Each pack follows the [animal naming convention](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/docs/NAMING_CONVENTION.md) and integrates seamlessly with Wayfinder's observability infrastructure.
...
1. **Naming**: Follow the [naming convention](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/docs/NAMING_CONVENTION.md)
