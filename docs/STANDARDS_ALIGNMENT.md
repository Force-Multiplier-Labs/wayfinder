...
- [ContextCore Semantic Conventions](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/docs/semantic-conventions.md)
- [ContextCore Agent Conventions](https://github.com/Force-Multiplier-Labs/contextcore-spec/blob/main/docs/agent-semantic-conventions.md)
